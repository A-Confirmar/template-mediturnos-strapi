...
export interface ApiHitorialClinicoHitorialClinico
  extends Struct.CollectionTypeSchema {
  collectionName: 'hitorial_clinicos';
  info: {
    displayName: 'hitorialClinico';
    pluralName: 'hitorial-clinicos';
    singularName: 'hitorial-clinico';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    diagnostico: Schema.Attribute.Blocks;
    fecha: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::hitorial-clinico.hitorial-clinico'
    > &
      Schema.Attribute.Private;
    observaciones: Schema.Attribute.Text;
    profesional: Schema.Attribute.Relation<
      'manyToOne',
      'api::profesional.profesional'
    >;
    publishedAt: Schema.Attribute.DateTime;
    tratamiento: Schema.Attribute.Blocks;
    turno: Schema.Attribute.Relation<'oneToOne', 'api::turno.turno'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProfesionalProfesional extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    calificacion_promedio: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    hitorial_clinicos: Schema.Attribute.Relation<
      'oneToMany',
      'api::hitorial-clinico.hitorial-clinico'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiResenaResena extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    motivo_rechazo: Schema.Attribute.Text;
    profesional: Schema.Attribute.Relation<
      'manyToOne',
      'api::profesional.profesional'
    >;
...
export interface ApiTurnoTurno extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    fecha: Schema.Attribute.DateTime;
    hitorial_clinico: Schema.Attribute.Relation<
      'oneToOne',
      'api::hitorial-clinico.hitorial-clinico'
    >;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    resena: Schema.Attribute.Relation<'oneToOne', 'api::resena.resena'>;
    respuesta_profesional: Schema.Attribute.Text;
    tipo: Schema.Attribute.Enumeration<['regular', 'express']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    profesional: Schema.Attribute.Relation<
      ...
      'api::profesional.profesional'
    >;
    profesionals: Schema.Attribute.Relation<
      'manyToMany',
      'api::profesional.profesional'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::hitorial-clinico.hitorial-clinico': ApiHitorialClinicoHitorialClinico;
